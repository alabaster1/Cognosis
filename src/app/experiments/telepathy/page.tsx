...
/**
 * Telepathy Experiment - Test mind-to-mind communication
 */
...
import { Users, Lock, Calendar, ArrowRight, Loader2 } from 'lucide-react';
...
export default function TelepathyPage() {
  ...
  const handleSetup = () => {
    if (!targetDate || !sessionType) {
      setError('Please select a target date and session type');
      return;
    }
    setError('');
    setStep('predict');
  ...
  const handleSubmitPrediction = async () => {
    ...
    try {
      const result = await experimentService.createCommitment({
        ...
        metadata: {
          type: 'telepathy',
          title: `Telepathy: ${sessionType}`,
          description: `Target date: ${targetDate}`,
          targetDate,
          category: 'telepathy',
          tags: ['telepathy', sessionType].filter(Boolean),
        },
      });
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-slate-400">Test mind-to-mind communication</p>
              </div>
            </div>
              ...
              <ol className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">
                      Select session type (one-on-one, group, long-distance) and target date
                    </p>
                  </div>
                </li>
                <li className="flex gap-3">
                  ...
                  <div>
                    <strong>Receive Impressions</strong>
                    <p className="text-slate-400 text-sm">
                      Record the thoughts, images, or impressions you received from another mind
                    </p>
                  </div>
                </li>
                <li className="flex gap-3">
                ...
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">
                      Compare your impressions with what was actually transmitted
                    </p>
                  </div>
                </li>
              </ol>
            ...
            <button
              ...
              className="w-full px-8 py-4 bg-gradient-to-r from-green-600 to-teal-600 rounded-lg font-semibold text-lg hover:shadow-lg hover:shadow-green-500/50 transition-all flex items-center justify-center gap-2"
            >
              Start Experiment
            ...
            <div className="space-y-6">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-[#0f1520] border border-[#1a2535] rounded-lg focus:border-green-500 focus:outline-none"
                >
                  <option value="">Select session type...</option>
                  <option value="one-on-one">One-on-One Session</option>
                  <option value="group">Group Session</option>
                  <option value="long-distance">Long-Distance Session</option>
                </select>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-slate-400 mt-2">
                  Choose when this session will occur or can be verified
                </p>
              </div>

              <button
                onClick={handleSetup}
                className="w-full px-6 py-3 bg-green-600 rounded-lg font-semibold hover:bg-green-700 transition-colors"
              >
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-slate-400 mb-8">
              Record impressions for session on {new Date(targetDate).toLocaleDateString()}
            </p>
            ...
            <div className="mb-6">
              <textarea
                ...
                placeholder="Describe the thoughts, images, or impressions you received..."
                rows={12}
                className="w-full px-4 py-3 bg-[#0f1520] border border-[#1a2535] rounded-lg focus:border-green-500 focus:outline-none resize-none"
              />
              <p className="text-sm text-slate-400 mt-2">
            ...
            <div className="bg-green-900/20 border border-green-500/50 rounded-lg p-4 mb-6 flex items-start gap-3">
              ...
              <div className="text-sm">
                <strong className="text-green-400">Privacy Protected</strong>
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full px-6 py-4 bg-gradient-to-r from-green-600 to-teal-600 rounded-lg font-semibold hover:shadow-lg hover:shadow-green-500/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
      ...
      <div className="min-h-screen bg-[#060a0f]">
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          >
            ...
            <p className="text-slate-400 mb-8">
              Your telepathy prediction has been encrypted and committed to the blockchain.
            </p>
